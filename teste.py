...
def executar_download():
            ...
            with open('version.txt', 'r+') as arquivo:
                try:
                    response = requests.get(
                        'https://raw.githubusercontent.com/Dz6k/Mir4-script-project/main/dist/main.exe', stream=True)
                    ...
                    # Se o download estiver concluído, mostrar um popup informando
    ...
    janela = tk.Tk()
    janela.title("Download com Barra de Progresso")
    ...
    # Define a função a ser chamada ao fechar a janela
    ...
    btn_iniciar = tk.Button(frame, text="Iniciar Download",
